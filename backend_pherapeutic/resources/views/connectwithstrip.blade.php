...
<link rel="shortcut icon" type="image/png" href="{{ URL::asset('img/shipgo/favicon.ico')}}"/>
 {{-- Html::style('css/custome.css') --}}
 
     <section class="signin-back">
    <!-- <span> <a class="cls" href="/home">x</a> </span> -->
    <div class="container">
            ...
            <div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-4">
                <div class="signin-inner">
                        <div class="logo-img">
                            ...
                            <img src="{{asset('/assets/media/logos/pherapeutic.png')}}" class="img-0" style="width: 300px;margin: 100px;">
						<p>
							<?php //if(!empty($_REQUEST['stripe_user_id'])) {
							//echo 'Your Account successfully setup.';	 
