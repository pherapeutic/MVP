...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Your Detail
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ $userObj->first_name }}</a>
                ...
                <div class="navi mt-2">
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        ...
                        <a href="{{url('admin/settings')}}"><i class="fa fa-cogs" aria-hidden="true"></i></a>
                    </form>
                </div>
            </div>
        </div>
