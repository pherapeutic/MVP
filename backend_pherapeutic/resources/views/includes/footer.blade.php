					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="{{url('/')}}" target="_blank" class="text-dark-75 text-hover-primary">Pherapeutic</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1">{{ Auth::user()->last_name }}</div>
						<div class="navi mt-2">
							...
							@csrf
								<input class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" type="submit" name="Sign Out" value="Sign Out">
							</form>
