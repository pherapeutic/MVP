...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover" id="questions_datatable">
                <thead>
                <tr>
                    <th>Question ID</th>
                    <th>Title</th>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.delete-datatable-record', function(e){
            let url  = base_url + "/admin/questions/" + $(this).attr('data-id');
            let tableId = 'questions_datatable';
