         ...
         <form class="form" method="POST" action="{{route('therapist.store')}}">
            <div class="card-body">
               <div class="form-group">
                @csrf
                <input type="hidden" value="Therapist" name="role"/>
                  <label>First Name:</label>
                  <input type="text" name="first_name" class="form-control form-control-solid" value="{{old('first_name')}}" placeholder="Enter first name" />
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="last_name" class="form-control form-control-solid" value="{{old('last_name')}}" placeholder="Enter last name" />
               ...
               <div class="form-group">
                  ...
                  <input type="email" name="email" class="form-control form-control-solid" value="{{old('email')}}" placeholder="Enter email" />
                  @if ($errors->has("email"))
                      <span class="form-text text-muted">
                        {{ $errors->first("email") }}
                      </span>
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="experience" class="form-control form-control-solid" value="{{old('experience')}}" placeholder="Enter Experience" />
