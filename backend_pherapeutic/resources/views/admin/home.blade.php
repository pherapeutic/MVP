...
<!--                         <h3 class="card-title font-weight-bolder text-white">Sales Stat</h3>
 -->                        <div class="card-toolbar">
                          <div class="dropdown dropdown-inline">
                            <a href="#" class="btn btn-transparent-white btn-sm font-weight-bolder dropdown-toggle px-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: none;">Export</a>
                        ...
                        <div class="card-spacer mt-n25">
                          ...
                          <div class="row m-0">
                            <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                              ...
                              <a href="{{ route('admin.client.index') }}" class="text-warning font-weight-bold font-size-h6">Total Clients : {{$totalClient}}</a>
                            </div>
                            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                              ...
                              <a href="{{ route('admin.therapist.index') }}" class="text-primary font-weight-bold font-size-h6 mt-2">Total Therapists : {{$totalTherapist}} </a>
                            </div>
                          </div>
                          <!--end::Row-->
                          <!--begin::Row-->
                          <div class="row m-0">
                            <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                              ...
                              <a href="{{ route('admin.appointments.index') }}" class="text-danger font-weight-bold font-size-h6 mt-2">Appointments : {{$totalAppointments}}</a>
                            </div>
                            <div class="col bg-light-success px-6 py-8 rounded-xl">
                              ...
                              <a href="{{ route('admin.contactus.index') }}" class="text-success font-weight-bold font-size-h6 mt-2">Contact Us : {{$contactUs}}</a>
                            </div>
                          </div>
                          <!--end::Row-->
                        </div>
                        <!--end::Stats-->
                      <div class="resize-triggers"><div class="expand-trigger"><div style="width: 386px; height: 461px;"></div></div><div class="contract-trigger"></div></div></div>
                      <!--end::Body-->
                    </div>
                    <!--end::Mixed Widget 1-->
                  </div>
...
<script>jQuery(function ($) {
  ...
  var therapistsJson = <?= $therapists?>;

  var therapistsJson = JSON.parse(JSON.stringify(therapistsJson));

  var therapists = [];

  $.each(therapistsJson, function(index, value) {
    therapists.push(value);
