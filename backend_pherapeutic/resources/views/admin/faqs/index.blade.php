    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Questionnaires
            ...
            <div class="card-toolbar">
                ...
                <span class="svg-icon svg-icon-md">
                    ...
                    <!--end::Svg Icon-->
                </span>New Questionnaire</a>
                <!--end::Button-->
            </div>
        </div>

        <div class="card-body">
            <table class="table table-bordered table-hover" id="faqs_datatable">
                <thead>
                <tr>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.delete-datatable-record', function(e){
            let url  = base_url + "/admin/faqs/" + $(this).attr('data-id');
            let tableId = 'faqs_datatable';
