...
@section('title') Create new Privacy & Policy @endsection
   ...
   <div class="col-lg-12">
      <div class="card card-custom gutter-b example example-compact">
         <div class="card-header">
            <h3 class="card-title">Add New Privacy & Policy</h3>
         ...
         <!--begin::Form-->
         <form class="form" method="POST" action="{{route('admin.privacypolicy.store')}}">
            @csrf
            <div class="card-body">
               <div class="row">
                  <div class="col-md-6">
