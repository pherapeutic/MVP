...
const AddCard = (props) => {
  ...
  const {secret_key_data} = route.params;

  // const [secret_key, setSecret_key] = useState(secret_key);
  ...
  const onAddCard = () => {
    if (!cardName) {
      ...
      //  let secret_key ='pk_test_51HyyqOEtbCkJm4K13uZJTnLdx473i22Mw4QjxYccE08eKN9n7i4Zw8sbU3iSTRWuL0pP6Oy3WsmyOgNA6HN6yWQC00OHQhokD7';
      // let secret_key ='pk_live_51HlXg4FPqRGJlf4F52MkXTzpKAnPIUHsxE94kpHNiL0eGgwwKfA1FmetaCG0KMo66tDn7ixwTNCtyXOlBMM5E2El00rZslAPDA';
      let secret_key = secret_key_data;
