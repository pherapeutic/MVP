    ...
    <Swiper
      ...
      <View style={styles.container}>
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
          ...
          <Text style={styles.contentText}>
            Pherapeutic makes its possible for you
          </Text>
          <Text style={styles.contentText}>
            to access the right talking therapies at
          </Text>
          <Text style={styles.contentText}>
            the time you need it the most - your
          </Text>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <Text style={styles.contentText}>
            Disorders or other mental health issue,
          </Text>
          <Text style={styles.contentText}>
            we have a range of therapists available
          </Text>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <Text style={styles.contentText}>
            To get started, simply sign up to the
          </Text>
          <Text style={styles.contentText}>
            app and complete the my profile
          </Text>
          <Text style={styles.contentText}>
            section. We’ve worked with a range of
          </Text>
          <Text style={styles.contentText}>
            psychologists and psychotherapists to
          </Text>
          <Text style={styles.contentText}>
            develop a questionnaire that helps to
          </Text>
          <Text style={styles.contentText}>
            provide a diagnosis of your mental
          </Text>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <Text style={styles.contentText}>
            We will match you to the right therapist
          </Text>
          <Text style={styles.contentText}>
            {' '}
            who is available to help talk you
          </Text>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <Text style={styles.contentText}>
            Work on yourself and rest will follow.
          </Text>
