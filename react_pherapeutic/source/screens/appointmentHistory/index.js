                        ...
                        item == null ?
                            ...
                            : <View style={styles.cardView}>
                                ...
                                <View style={styles.contentView}>
                                    ...
                                    <View style={{ flexDirection: "row", height: 20, width: 110, borderRadius: 4, backgroundColor: constants.colors.greenText, marginTop: 5 }}>
                                        <Text style={{ paddingLeft: 5 ,fontSize:10,paddingTop:3}}></Text>
                                ...
                                <View style={styles.paidView}>
                                    <View style={{ flexDirection: "row", justifyContent: "flex-end" }}><Text style={{ color: "rgb(20,20,20)", fontSize: 14, fontWeight: "bold" }}>Paid:{item.transfer_amount}</Text></View>
                                    <View style={{ flexDirection: "row", justifyContent: "flex-end",paddingTop:10,paddingLeft:5 }}><Text style={{ color: "rgb(4,4,4)", fontSize: 10, textDecorationLine: 'underline' }}
                                        onPress={() => {
                                            showpopup(item.comment)
