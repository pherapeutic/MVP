      ...
      <View style={styles.container} >
        ...
        <View style={styles.content} >
          <View style={styles.heading} >
            <Text style={styles.topText} >Enter the six digit code we sent you</Text>
          ...
          <View style={styles.formWrap} >
            ...
            <View style={[styles.formField, { height: height * 0.03 }]} >
              <Text>Didn't get the code? <Text style={{ color: constants.colors.greenText }} >Resend</Text></Text>
            </View>
          </View>
        </View>
      </View>
